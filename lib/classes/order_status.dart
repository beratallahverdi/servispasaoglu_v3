...
class OrderStatus {
  ...
  static const String inVisible = 'In Visible';
  static const String visible = 'Visible';
  static Map<String, Color> colors = <String, Color>{
    draft: Colors.deepPurple.shade700,
    waiting: Colors.lightBlue.shade700,
    inProgress: Colors.orange.shade700,
    completed: Colors.green.shade700,
    rejected: Colors.red.shade700,
    locked: Colors.deepPurple.shade700,
  };
